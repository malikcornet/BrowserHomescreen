...
export const createDefaultRootDirectory = (): DirectoryItem => {
  const quickLinks = [
  ...
  return new DirectoryItem("/", [...quickLinks, workDirectory]);
};

// Backward-compatible export while moving initialization to runtime hydration.
export const rootDirectory = createDefaultRootDirectory();
